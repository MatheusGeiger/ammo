    ...
    constructor(props) {
        ...
        this.state = {
            fields: {
                ...
                percentageDiscount:  props.product.percentageDiscount,
                category: props.product.category,
                photos: JSON.stringify(props.product.photos)
            },
            validationErrors: []
        };
            ...
            <div className="card card-body">
                ...
                <form onSubmit={this.onSave} className="mt-2">
                    <div className="form-group">
                        <label htmlFor="_id" hidden>Id</label>
                        <input type="text" className="form-control" name="id" readOnly hidden value={this.state.fields._id} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="title">Title</label>
                        <input type="text" className="form-control" name="title" autoFocus onChange={this.onChangeField} value={this.state.fields.title} />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" className="form-control" min="0" max="100" name="percentageDiscount" autoFocus onChange={this.onChangeField} value={this.state.fields.percentageDiscount}/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="category">Category</label>
                        <input type="text" className="form-control" name="category" autoFocus onChange={this.onChangeField} value={this.state.fields.category} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="photos">Photos</label>
                        <input type="text" className="form-control" name="photos" autoFocus onChange={this.onChangeField} value={this.state.fields.photos} />
                    </div>
